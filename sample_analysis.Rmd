...
A-priori power analyses showed that to detect a small (*f* = .02) main effects for condition, and order and a small order x interaction effect a minimum sample of 184 participants is required.

# Sample Analysis

Below we present a sample analysis described above using simulated data.
